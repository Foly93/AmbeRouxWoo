...
class BlockedIstar_estimator:
    ...
    def calculateBlockedContribution(self, mode: _MODES = 'forward'):
        ...
        for Samplesizes in block_originHSamplesizes:
            ...
            Work_PMF = PMF[:dissociationBoundaryIndex] - dPMF[:dissociationBoundaryIndex]  ### the subtraction is not necessary, actually it is wrong. needs to be tested without !
